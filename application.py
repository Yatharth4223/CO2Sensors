...
class Application():
    ...
    def createSensors(self,listOfSensors =[]):
        ...
        for index in range(int(noOfSensors)):
            ...
            self.setId(id)
            #This snippet checks if id is int
            #sen = "Sensor " + id
            ...
            if(noOfNeighbours !=0):
                ...
                for index in range(int(noOfNeighbours)):
                    ...
                    while(dist.isnumeric() ==False):
                        ...
                        dist = input("Enter the Oxygen level in %: ")
    ...
    def convrtToDictionary(self):
        ...
        '''
        if(self._neighId !=""):
            str ='distance with neighbour: '+self._neighId+": "
            disindex = listOfSensors.index(str)
            dict={"sensor id":self._id,"neighbour id":self._neighId,"distance from neighbour "+self._neighId:listOfSensors[disindex+1]}
        else:
            dict={"sensor id":self._id,"neighbour id":"No neighbour"}
        '''
